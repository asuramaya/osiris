...
Palantir's object sets: a **relation** is a link, and a **rollup** is an aggregate over that
link. That convergence told us the closed op set is right, not invented.
