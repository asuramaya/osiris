"""THE ONLY CODE THAT TOUCHES JINJA. Every other module in this subpackage builds a typed
Block tree (blocks.py) and hands it here; nothing else imports jinja2 or the templates
directory. `render_page` and `render_block` are the two entry points: a builder (inbox.py)
or a route (app.py) never formats HTML by hand."""
