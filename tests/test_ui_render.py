...
# table()'s own cell clamp: `.r-table td .clamp` has
...
# objects-mode's missing cap: the "open threads" lens
...
# NESTED CELL VALUES (task #109's tail; compositions.py:2216's own documented
# gap): neither render_composition (chrome.py, left untouched: its route
